# 🚀 Tutoriel Complet: Déploiement Chatbot Widget sur VPS Docker

> **Objectif**: Déployer le chatbot widget bulle sur ton VPS Docker existant (0€/mois)
> **Durée**: 15-20 minutes
> **Niveau**: Débutant
...
- ✅ Traefik configuré (pour SSL auto)
- ✅ Accès SSH au VPS
...
https://bot.oraclesentinel.com/embed?widget_id=default
       ↓
VPS Docker: Chatbot Backend + PostgreSQL
       ↓
Groq API (Llama 3.3) + CRM (Twenty/Airtable)
```
...
## ÉTAPE 3: Configuration Docker Compose (3 min)
...
## ÉTAPE 5: Vérification DNS (2 min)
...
| Plan | Prix | Limites |
|------|------|---------|
| **Trial** | 0€ (30 jours) | $5 de crédits, idéal pour tests |
| **Hobby** | 5$/mois | 512MB RAM, 1GB storage, obligatoire après trial |
| **Pro** | 20$/mois | 2GB RAM, 8GB storage, custom domain |
